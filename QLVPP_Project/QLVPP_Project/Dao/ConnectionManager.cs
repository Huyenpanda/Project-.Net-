...
namespace QLVPP_Project.Dao
{
    ...
    {
        private static readonly string connectString = "Data Source=JERRY\\SQLEXPRESS;Initial Catalog=VanPhongPham;User ID=sa;Password=1234$;TrustServerCertificate=True";
